...
import test.mongodb.etl.ApplicationContext;
import test.mongodb.etl.Document;
import test.mongodb.etl.DocumentMetaData;
...
public class ProducerThread extends Thread {
	...
	private void loadData(Class<?> type) {
		try {
			...
			test.mongodb.etl.annotation.Document document = type.getDeclaredAnnotation(test.mongodb.etl.annotation.Document.class);
